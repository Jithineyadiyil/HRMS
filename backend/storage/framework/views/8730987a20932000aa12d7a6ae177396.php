...
<title>Payslip – <?php echo e($payslip->employee->employee_code ?? ''); ?> – <?php echo e($payslip->payroll->month ?? ''); ?></title>
<style>
    ...
    <table class="header-table">
      <tr>
        <td class="header-left">
          ...
          <img src="file://<?php echo e(public_path('diamond-logo.png')); ?>" class="logo-img" alt="Diamond Insurance Broker">
          <div class="company-sub">Human Resources Department</div>
        </td>
        <td class="header-right">
          <div class="doc-title">Pay Slip</div>
          <div class="doc-period"><?php echo e(\Carbon\Carbon::parse($payslip->payroll->month . '-01')->format('F Y')); ?></div>
          <div class="doc-dates">
            Period: <?php echo e(\Carbon\Carbon::parse($payslip->payroll->period_start)->format('d M Y')); ?>

            &ndash; <?php echo e(\Carbon\Carbon::parse($payslip->payroll->period_end)->format('d M Y')); ?>
    ...
    <table class="emp-table">
      <tr>
        <td class="emp-cell">
          ...
          <div class="emp-val"><?php echo e($payslip->employee->first_name); ?> <?php echo e($payslip->employee->last_name); ?></div>
          <div class="emp-val2"><?php echo e($payslip->employee->designation?->title ?? '—'); ?></div>
        </td>
        <td class="emp-cell">
          <div class="emp-lbl">Employee ID</div>
          <div class="emp-val"><?php echo e($payslip->employee->employee_code); ?></div>
          <div class="emp-val2"><?php echo e($payslip->employee->department?->name ?? '—'); ?></div>
        </td>
        <td class="emp-cell">
          <div class="emp-lbl">Nationality</div>
          <div class="emp-val" style="color:<?php echo e($payslip->is_saudi ? '#1a7a50' : '#2563eb'); ?>">
            <?php echo e($payslip->is_saudi ? 'Saudi National' : 'Non-Saudi Expatriate'); ?>

          </div>
          <div class="emp-val2">Pay Date: <?php echo e(\Carbon\Carbon::parse($payslip->payroll->period_end)->format('d M Y')); ?></div>
        </td>
        <td class="emp-cell" style="padding-right:0">
          <div class="emp-lbl">Reference No.</div>
          <div class="emp-val"><?php echo e('PAY-' . str_replace('-', '', $payslip->payroll->month) . '-' . str_pad($payslip->employee_id, 4, '0', STR_PAD_LEFT)); ?></div>
          <div class="emp-val2">Generated: <?php echo e(now()->format('d M Y')); ?></div>
        </td>
      </tr>
    </table>
  </div>
    ...
    <table class="net-table">
      <tr>
        <td class="net-left">
          ...
          <div class="net-val">SAR <?php echo e(number_format($payslip->net_salary, 2)); ?></div>
          <div class="net-sub">
            Gross SAR <?php echo e(number_format($payslip->gross_salary, 2)); ?>

            &nbsp;&minus;&nbsp;
            Deductions SAR <?php echo e(number_format($payslip->total_deductions, 2)); ?>

          </div>
        </td>
        <td class="net-right">
          <div class="net-lbl" style="margin-bottom:7px">Attendance Summary</div>
          <span class="chip chip-blue"><?php echo e($payslip->working_days ?? 0); ?> Days Worked</span>
          <?php if(($payslip->absent_days ?? 0) > 0): ?>
            <span class="chip chip-red"><?php echo e($payslip->absent_days); ?> Absent</span>
          <?php endif; ?>
          <?php if(($payslip->leave_days ?? 0) > 0): ?>
            <span class="chip chip-orange"><?php echo e($payslip->leave_days); ?> Leave</span>
          <?php endif; ?>
        </td>
      </tr>
    </table>
      ...
      <tr>
        ...
        <td class="bd-earn">
          ...
          <table class="row row-sep" style="margin-bottom:0"><tr>
            ...
            <td class="row-val earn-v">SAR <?php echo e(number_format($payslip->basic_salary, 2)); ?></td>
          </tr></table>
          ...
          <table class="row row-sep" style="margin-bottom:0"><tr>
            ...
            <td class="row-val earn-v">SAR <?php echo e(number_format($payslip->housing_allowance, 2)); ?></td>
          </tr></table>
          ...
          <table class="row row-sep" style="margin-bottom:0"><tr>
            ...
            <td class="row-val earn-v">SAR <?php echo e(number_format($payslip->transport_allowance, 2)); ?></td>
          </tr></table>

          <?php if(($payslip->other_allowances ?? 0) > 0): ?>
          <table class="row row-sep" style="margin-bottom:0"><tr>
            <td class="row-lbl">Other Allowances</td>
            <td class="row-val earn-v">SAR <?php echo e(number_format($payslip->other_allowances, 2)); ?></td>
          </tr></table>
          <?php endif; ?>

          <table class="sec-total"><tr class="st-row tot-earn">
            <td class="st-lbl tot-earn">Total Earnings</td>
            <td class="st-val tot-earn">SAR <?php echo e(number_format($payslip->total_earnings ?? $payslip->gross_salary, 2)); ?></td>
          </tr></table>
        </td>
        ...
        <td class="bd-deduct">
          ...
          <?php if($payslip->is_saudi): ?>
            <table class="row row-sep" style="margin-bottom:0"><tr>
              <td class="row-lbl">
                GOSI &mdash; Employee Share
                <span class="row-hint">9% of basic salary (deducted)</span>
              </td>
              <td class="row-val deduct-v">SAR <?php echo e(number_format($payslip->gosi_employee, 2)); ?></td>
            </tr></table>
            ...
            <table class="row row-sep" style="margin-bottom:0"><tr>
              ...
              <td class="row-val info-v">SAR <?php echo e(number_format($payslip->gosi_employer, 2)); ?></td>
            </tr></table>
          <?php else: ?>
            <table class="row row-sep" style="margin-bottom:0"><tr>
          ...
          <?php if(($payslip->other_deductions ?? 0) > 0): ?>
          <table class="row row-sep" style="margin-bottom:0"><tr>
            <td class="row-lbl">Other Deductions</td>
            <td class="row-val deduct-v">SAR <?php echo e(number_format($payslip->other_deductions, 2)); ?></td>
          </tr></table>
          <?php endif; ?>

          <table class="sec-total"><tr class="st-row tot-deduct">
            <td class="st-lbl tot-deduct">Total Deductions</td>
            <td class="st-val tot-deduct">SAR <?php echo e(number_format($payslip->total_deductions, 2)); ?></td>
          </tr></table>

          <?php if($payslip->is_saudi): ?>
          <div class="gosi-box">
            <strong>GOSI Note:</strong> Employee contribution of
            <strong>SAR <?php echo e(number_format($payslip->gosi_employee, 2)); ?></strong> (9%) is deducted from salary.
            Employer contributes <strong>SAR <?php echo e(number_format($payslip->gosi_employer, 2)); ?></strong> (11.75%)
      ...
      <table class="sm-table">
        <tr>
          <td class="sm-cell">
            ...
            <div class="sm-val">SAR <?php echo e(number_format($payslip->gross_salary, 2)); ?></div>
          </td>
          <td class="sm-sep">&nbsp;</td>
          <td class="sm-cell">
            <div class="sm-lbl">Total Deductions</div>
            <div class="sm-val" style="color:#f87171">SAR <?php echo e(number_format($payslip->total_deductions, 2)); ?></div>
          </td>
          <td class="sm-sep">&nbsp;</td>
          <td class="sm-cell">
            <div class="sm-lbl">Net Salary Payable</div>
            <div class="sm-val sm-hl">SAR <?php echo e(number_format($payslip->net_salary, 2)); ?></div>
          </td>
          <td class="sm-sep">&nbsp;</td>
          <td class="sm-cell">
            <div class="sm-lbl">Days Worked</div>
            <div class="sm-val"><?php echo e($payslip->working_days ?? 0); ?> / 30</div>
          </td>
        </tr>
      </table>
    </div>
    ...
    <table class="ft-table">
      <tr>
        ...
        <td class="ft-right" style="width:35%">
          Ref: PAY-<?php echo e(str_replace('-', '', $payslip->payroll->month)); ?>-<?php echo e(str_pad($payslip->employee_id, 4, '0', STR_PAD_LEFT)); ?><br>
          Employee ID: <?php echo e($payslip->employee->employee_code); ?><br>
          Issued: <?php echo e(now()->format('d M Y, H:i')); ?>
...
<?php /**PATH D:\xamp new\htdocs\HRMS\backend\resources\views/payslip.blade.php ENDPATH**/ ?>